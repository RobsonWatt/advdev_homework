...
echo "Set up Jenkins with sufficient resources"
...
# TBD
echo "Create pipeline build config pointing to the ${REPO} with contextDir openshift-tasks"
oc new-app ${REPO} --context-dir=openshift-tasks
